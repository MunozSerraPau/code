            ...
            <div class="card shadow p-4 bg-light" style="max-width: 400px; width: 100%; backdrop-filter: blur(10px); border-radius: 25px; border: 3px solid #454962;">
                <form <?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>, method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="username" name="username" class="form-control" value="<?php echo $recordamUsuari; ?>">
                    </div>
                    ...
                    <div>
                        <a href="<?php echo BASE_URL; ?>/controlador/HybridAuthReddit.controlador.php" aria-label="Iniciar sesión con Reddit" class="btn btn-reddit border-0 p-0 d-flex align-items-center justify-content-center" style="width: 100px; height: 100px;">
