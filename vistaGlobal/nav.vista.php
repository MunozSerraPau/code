...
<?php if(isset($_SESSION['usuario'])): 
    ...
    <nav class="navbar bg-body-tertiary fixed-top">
      <div class="container-fluid">
        ...
        <a class="navbar-brand d-flex align-content-center" href="./index.php">
      ...
      <div class="container-fluid">
        ...
        >
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              <li class="nav-item">
                <a class="nav-link" href="<?php echo BASE_URL; ?>/vista/login.php">LOGIN</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo BASE_URL; ?>/vista/login.php">SING UP</a>
              </li>
            </ul>
          </div>
        </div>
